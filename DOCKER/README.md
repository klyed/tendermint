...
Official releases can be found [here](https://github.com/klyed/tendermint/releases).
...
- **Where to file issues:** <https://github.com/klyed/tendermint/issues>
...
To run a 4-node network, see the `Makefile` in the root of [the repo](https://github.com/klyed/tendermint/blob/master/Makefile) and run:
...
- Tendermint's license is [Apache 2.0](https://github.com/klyed/tendermint/blob/master/LICENSE).

## Contributing

Contributions are most welcome! See the [contributing file](https://github.com/klyed/tendermint/blob/master/CONTRIBUTING.md) for more information.
