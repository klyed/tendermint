...
(ABCI)](https://github.com/klyed/tendermint/tree/master/abci)
...
[Tendermint Core](https://github.com/klyed/tendermint) (the
...
Types](https://github.com/klyed/tendermint/blob/master/abci/README.md#message-types).
