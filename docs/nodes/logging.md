...
- `abci-client` As mentioned in [Application Development Guide](../app-dev/app-development.md), Tendermint acts as an ABCI
  ...
  be found [here](https://github.com/klyed/tendermint/tree/master/abci/client).
...
- `consensus` The heart of Tendermint core, which is the
  ...
  from a crash.
  [here](https://github.com/klyed/tendermint/blob/master/types/events.go).
...
- `p2p` Provides an abstraction around peer-to-peer communication. For
  ...
  [README](https://github.com/klyed/tendermint/blob/master/p2p/README.md).
- `rpc-server` RPC server. For implementation details, please read the
  [doc.go](https://github.com/klyed/tendermint/blob/master/rpc/jsonrpc/doc.go).
