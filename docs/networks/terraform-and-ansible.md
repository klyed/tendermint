...
script](https://github.com/klyed/tendermint/blob/master/networks/remote/integration.sh)
...
directory](https://github.com/klyed/tendermint/tree/master/networks/remote/ansible)
