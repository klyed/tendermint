...
file](https://github.com/klyed/tendermint/blob/master/proto/tendermint/abci/types.proto).
...
```bash
mkdir -p \
  $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/abci \
  $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/version \
  $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/types \
  $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/crypto \
  $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/libs \
  $KVSTORE_HOME/src/main/proto/github.com/gogo/protobuf/gogoproto

cp $GOPATH/src/github.com/klyed/tendermint/proto/tendermint/abci/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/abci/types.proto
cp $GOPATH/src/github.com/klyed/tendermint/proto/tendermint/version/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/version/types.proto
cp $GOPATH/src/github.com/klyed/tendermint/proto/tendermint/types/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/types/types.proto
cp $GOPATH/src/github.com/klyed/tendermint/proto/tendermint/types/evidence.proto \
   $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/types/evidence.proto
cp $GOPATH/src/github.com/klyed/tendermint/proto/tendermint/types/params.proto \
   $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/types/params.proto
cp $GOPATH/src/github.com/klyed/tendermint/proto/tendermint/crypto/proof.proto \
   $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/crypto/proof.proto
cp $GOPATH/src/github.com/klyed/tendermint/proto/tendermint/crypto/keys.proto \
   $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/crypto/keys.proto
cp $GOPATH/src/github.com/klyed/tendermint/proto/tendermint/libs/bits/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/klyed/tendermint/proto/tendermint/libs/bits/types.proto
...
package](https://godoc.org/github.com/klyed/tendermint/light)) can leverage
...
```bash
rm -rf /tmp/example
cd $GOPATH/src/github.com/klyed/tendermint
make install
...
Github](https://github.com/klyed/tendermint/issues/new/choose). To dig
