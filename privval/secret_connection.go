...
import (
	...
	"github.com/klyed/tendermint/libs/async"
	"github.com/klyed/tendermint/libs/protoio"
	tmsync "github.com/klyed/tendermint/libs/sync"
	tmprivval "github.com/klyed/tendermint/proto/tendermint/privval"
)
...
// https://github.com/klyed/tendermint/issues/4698
...
// See https://github.com/klyed/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/klyed/tendermint/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/klyed/tendermint/issues/3531
