...
* Here are some common library labels for consistency:
    ...
    * tmcmd "github.com/klyed/tendermint/cmd/tendermint/commands"
    * tmcfg "github.com/klyed/tendermint/config/tendermint"
...
* When importing a pkg from the `tendermint/libs` directory, prefix the pkg alias with tm.
    * tmbits "github.com/klyed/tendermint/libs/bits"
