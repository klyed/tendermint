...
git clone https://github.com/klyed/tendermint.git
cd tendermint
## build
make tools
make build
...
cd $GOPATH/src/github.com/klyed/tendermint/networks/remote/terraform
...
cd $GOPATH/src/github.com/klyed/tendermint/networks/remote/ansible

# create config dirs
tendermint testnet

ansible-playbook -i inventory/digital_ocean.py -l sentrynet install.yml
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/klyed/tendermint/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/klyed/tendermint/networks/remote/ansible/mytestnet
...
old_ansible_file=$GOPATH/src/github.com/klyed/tendermint/networks/remote/ansible/roles/install/templates/systemd.service.j2
rm $old_ansible_file
